                            ...
                            (<div className={classes.markerContainer} lat={Number(place.latitude)} lng={Number(place.longitude)}>
                                {
                                    isMobile ? (
                                        ...
                                        <Paper elevation={3} className={classes.paper} >
                                            <Typography className={classes.maptitle} variant="subtitle2" gutterBottom>
                                                {place.name}
                                            </Typography>
                                            <img
                                                ...
                                                alt={place.name}
                                            />
                                            <Rating className={classes.maprating} size="small" value={Number(place.rating)} readOnly></Rating>
                                        </Paper>
                                    )
                                }
                            </div>) : null
